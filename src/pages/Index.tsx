      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container relative">
          <motion.div
            initial="hidden"
            animate="visible"
            className="mx-auto max-w-3xl text-center py-16"
          >
            <motion.div variants={fadeUp} custom={0} className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-accent px-4 py-1.5 text-sm font-medium text-accent-foreground mb-6">
              <Sparkles className="h-4 w-4" /> Powered by AI
            </motion.div>
            <motion.h1 variants={fadeUp} custom={1} className="text-5xl md:text-6xl font-bold tracking-tight text-foreground mb-6 leading-tight">
            ...
            <motion.p variants={fadeUp} custom={2} className="text-lg text-muted-foreground max-w-xl mx-auto mb-8">
              Experience smart, personalized learning with AI-driven recommendations, interactive tutoring, and structured courses designed for the modern learner.
            </motion.p>
